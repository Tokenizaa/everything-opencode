---
name: Diretrizes de Desenvolvimento Frontend
description: Padrões opinativos de desenvolvimento frontend para aplicações modernas em React + TypeScript. Cobre Suspense-first data fetching, lazy loading, arquitetura baseada em features, MUI v7 styling, TanStack Router. Avaliada com 4/5 estrelas. (⭐⭐⭐⭐)
category: frontend
risk: safe
source: community
