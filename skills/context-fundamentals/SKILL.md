---
name: Fundamentos de Contextos de IA
category: ai
risk: safe
description: "Esta skill deve ser usada quando o usuário pergunta sobre 'entender contextos', 'explicar janelas de contexto', 'projetar arquitetura de agentes', 'depurar problemas de contexto', 'otimizar uso de contexto', ou discute componentes de contexto, mecânica de atenção, revelação progressiva ou orçamento de contexto. Avaliada com 4/5 estrelas. (⭐⭐⭐⭐)"
---
