...
description: "Especialista no framework Nest.js especializado em arquitetura de módulos, injeção de dependência, middleware, guards, interceptors, testes com Jest/Supertest, integração TypeORM/Mongoose e autenticação Passport.js. Avaliada com 4/5 estrelas. (⭐⭐⭐⭐)"
category: backend
risk: safe
source: community
